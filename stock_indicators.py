"""
Chỉ báo kỹ thuật - port thuần Python từ repo stock-portfolio:
  src/lib/server/ai/technical.ts (RSI, momentum, volatility, decision score)
  src/lib/server/technical-indicators.ts (MACD, Bollinger, ADX, multi-timeframe,
    SMA cross, support/resistance, bias MA, MA alignment, trend score)

Toàn bộ hàm ở đây thuần toán học trên close[]/high[]/low[]/volume[] - không gọi
mạng - nên port 1:1 an toàn.
"""
